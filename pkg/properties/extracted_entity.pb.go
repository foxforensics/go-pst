...
type ExtractedEntity struct {
	...
	ExtractedAddresses *string `json:"extracted_addresses,omitempty"`
	// Contains an XML document with a single ContactSet element.
	ExtractedContacts *string `json:"extracted_contacts,omitempty"`
	...
	ExtractedMeetings *string `json:"extracted_meetings,omitempty"`
	...
	ExtractedTasks *string `json:"extracted_tasks,omitempty"`
...
var file_extracted_entity_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x75, 0x72, 0x6c, 0x73, 0x42, 0x29, 0x5a, 0x27, 0x67,
