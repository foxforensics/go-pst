...
type RSS struct {
	...
	PostRssChannel *string `json:"post_rss_channel,omitempty"`
	// Contains the URL of the RSS or Atom feed from which the XML file came.
	PostRssChannelLink *string `json:"post_rss_channel_link,omitempty"`
	// Contains a unique identifier for the RSS object.
	PostRssItemGuid *string `json:"post_rss_item_guid,omitempty"`
	// Contains a hash of the feed XML computed by using an implementation-dependent algorithm.
	PostRssItemHash *int32 `json:"post_rss_item_hash,omitempty"`
	// Contains the URL of the link from an RSS or Atom item.
	PostRssItemLink *string `json:"post_rss_item_link,omitempty"`
	...
	PostRssItemXml *string `json:"post_rss_item_xml,omitempty"`
	// Contains the user's preferred name for the RSS or Atom subscription.
	PostRssSubscription *string `json:"post_rss_subscription,omitempty"`
}
