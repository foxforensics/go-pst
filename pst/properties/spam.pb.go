...
type Spam struct {
	...
	JunkAddRecipientsToSafeSendersList *int32 `json:"junk_add_recipients_to_safe_senders_list,omitempty"`
	...
	JunkIncludeContacts *int32 `json:"junk_include_contacts,omitempty"`
	// Indicates whether messages identified as spam can be permanently deleted.
	JunkPermanentlyDelete *int32 `json:"junk_permanently_delete,omitempty"`
	// Indicated whether the phishing stamp on a message is to be ignored.
	JunkPhishingEnableLinks *bool `json:"junk_phishing_enable_links,omitempty"`
	// Indicates how aggressively incoming email is to be sent to the Junk Email folder.
	JunkThreshold *int32 `json:"junk_threshold,omitempty"`
}
...
var file_spam_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74,
